<?php
$months = str_replace(array('"', "'"), array('\"', "\'"), __('months', true, true));
...
if (jQuery_1_8_2.datagrid !== undefined) {
	jQuery_1_8_2.extend(jQuery_1_8_2.datagrid.messages, {
		...
		empty_datetime: "<?php __('gridEmptyDatetime'); ?>",
		invalid_datetime: "<?php __('gridInvalidDatetime'); ?>"
	});
}
...
if (abApp !== undefined) {
	abApp = jQuery_1_8_2.extend(abApp, {
		locale: {
